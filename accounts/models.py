...
from socialiga.utils import unique_key_generator, unique_slug_generator_by_email, random_string_generator
...
class Profile(models.Model):
    ...
    account_type = models.CharField(choices=ACCOUNT_TYPE, max_length=300, default='CUSTOMER', blank=True, null=True)
